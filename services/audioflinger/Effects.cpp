...
// Loudness Enhancer (Volume Booster)
static const effect_uuid_t SL_IID_LOUDNESS_ENHANCER_ = // fe3a3566-a5b5-4641-bb39-4b12da515436
{ 0xfe3a3566, 0xa5b5, 0x4641, 0xbb39, {0x4b, 0x12, 0xda, 0x51, 0x54, 0x36} };
const effect_uuid_t * const SL_IID_LOUDNESS_ENHANCER = &SL_IID_LOUDNESS_ENHANCER_;
    ...
    if ((desc.flags & EFFECT_FLAG_NOT_ELIGIBLE_SUSPEND) ||
        ((mSessionId == AUDIO_SESSION_OUTPUT_MIX) &&
         (((desc.flags & EFFECT_FLAG_TYPE_MASK) == EFFECT_FLAG_TYPE_AUXILIARY) ||
          ...
          (memcmp(&desc.type, SL_IID_LOUDNESS_ENHANCER, sizeof(effect_uuid_t)) == 0) ||
